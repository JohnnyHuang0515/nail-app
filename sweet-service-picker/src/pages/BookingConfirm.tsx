          ...
          <div className="bg-card rounded-3xl overflow-hidden shadow-lg border border-border">
            ...
            <div className="bg-milk-tea-light/30 px-5 py-4 border-b border-dashed border-milk-tea/40">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-muted-foreground font-medium">預約代號</p>
            ...
            <div className="px-5 py-5 space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs text-muted-foreground font-medium">日期與時間</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs text-muted-foreground font-medium">地點</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs text-muted-foreground font-medium">服務項目</p>
                  <p className="text-base font-semibold text-foreground">
                    {bookingData.itemCount} 項服務
                  </p>
                  <p className="text-sm text-muted-foreground">
                    預計時間: ~{bookingData.totalTime} 分鐘
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs text-muted-foreground font-medium">客戶資料</p>
                  <p className="text-base font-semibold text-foreground">{bookingData.customerName || "貴賓"}</p>
